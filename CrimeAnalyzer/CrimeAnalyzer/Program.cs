...
namespace CrimeAnalyzer
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            if (args.Length < 2)
            {
                Console.WriteLine("Not enough arguments... Please enter a source and report file.");
                Console.ReadLine();
                return;
            }
            else if (args.Length > 2)
            {
                Console.WriteLine("Too many arguments... Please only enter a source and report file.");
                Console.ReadLine();
                return;
            }
            ...
            try
            {
                ...
                while (!sourceFile.EndOfStream)
                {
                    ...
                    if (column.Length < 11)
                    {
                        Console.WriteLine("Error: Row {0} of data contains {1} values. Each row should have 11 data elements. Please correct and try again... Report was not created.", count, column.Length);
                        Console.ReadLine();
                        return;
                    }
            ...
            {
                Console.WriteLine("Error: Source file cannot be opened... Report was not created.");
                Console.ReadLine();
                return;
            }
